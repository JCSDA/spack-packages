...
class PyPyresample(PythonPackage):
    ...
    depends_on("py-cartopy", type=("build", "test", "run"))
    depends_on("py-dask", type=("build", "test", "run"))
    depends_on("py-numexpr", type=("build", "test", "run"))
    depends_on("py-rasterio", type=("build", "test", "run"))
    ...
    with when("+tests"):
        ...
        depends_on("py-odc-geo", type="run")
        depends_on("py-pillow", type="run")
        depends_on("py-pytest", type="run")
        depends_on("py-pytest-lazy-fixtures", type="run")
        depends_on("py-rasterio", type="run")
